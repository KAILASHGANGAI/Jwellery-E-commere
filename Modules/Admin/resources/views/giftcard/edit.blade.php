...
@section('content')
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-12">
                <form id="product-form" class="product-form" action="{{ route('giftcards.update', $data->id) }}" method="POST"
                        ...
                        <div class="col-sm-8">
                            <div class="row">
                                ...
                                <div class="form-section d-fllex col-sm-6">
                                    ...
                                    <input type="text" id="code" name="code" value="{{ old('code', $data->code) }}" required>
                                </div>
                                <div class="form-section col-sm-6">
                                    <label for="value">Amount (Rs)</label>
                                    <input type="number" id="value" name="value" value="{{ old('value', $data->value) }}" required>
                                </div>
                                                        
                                <div class="form-section col-sm-12">
                                    <label for="title">Customer</label>
                                    <input type="hidden" id="customer_id" name="customer_id" value="{{ old('customer_id', $data->customer_id) }}">
                                    <input type="text" id="customers"  value="{{ old('customer', $data->customer->name) }}"
                                        placeholder="Short sleeve t-shirt" required>
