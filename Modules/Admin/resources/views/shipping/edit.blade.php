...
@section('content')
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-12">
                <form id="product-form" class="product-form" action="{{ route('shipping.update', $data->id) }}" method="POST"
                                ...
                                <span class="back-button">
                                    <h4 class="main-title ">
                                        <a class="text-decoration-none text-dark" href="{{ route('shipping.index') }}">
                                            <span>← </span>Update Shipping area</a>
                                    </h4>
                                </span>
                        ...
                        <div class="col-sm-8">
                            <div class="row">
                                ...
                                <div class="form-section col-sm-4">
                                    ...
                                    <input type="text" id="country" name="country" value="{{ old('country', $data->country) }}"
                                        placeholder="Country">
                                </div>
                                <div class="form-section col-sm-4">
                                    <label for="state">State</label>
                                    <input type="text" id="state" name="state" value="{{ old('state', $data->state) }}"
                                        placeholder="state">
                                </div>
                                <div class="form-section col-sm-4">
                                ...
                                <div class="form-section col-sm-4">
                                    ...
                                    <input type="text" id="zipcode" name="zipcode" value="{{ old('zipcode', $data->zipcode) }}"
                                        placeholder="zipcode">
                                </div>
                                <div class="form-section col-sm-4">
                                    <label for="amount">Amount</label>
                                    <input type="text" id="amount" name="amount" value="{{ old('amount', $data->amount) }}"
                            ...
                            <aside class="">
                                <div class="sidebar-section card p-3">
                                    ...
                                    <select id="status" name="status"  required>
                                        ...
                                        <option {{ old('status', $data->status) == '1' ? 'selected' : '' }} value="1">Active
                                        </option>
                                    </select>
                                </div>
