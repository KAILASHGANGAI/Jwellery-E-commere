...
@section('content')
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-12">
                <form id="product-form" class="product-form" action="{{ route('customers.store') }}" method="POST"
                        ...
                        <div class="col-sm-8">
                            <div class="row">
                                ...
                                <div class="form-section col-sm-6">
                                    ...
                                    <textarea name="billingAddress" id="" placeholder="full address"> {{ old('billingAddress') }}</textarea>
                                </div>
                                <div class="form-section col-sm-6">
                                    <label for="shippingAddress">Shipping Address</label>
                                    <textarea name="shippingAddress" id="" placeholder="full address"> {{ old('shippingAddress') }}</textarea>
                                </div>
