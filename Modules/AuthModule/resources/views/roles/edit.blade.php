...
@section('content')
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-12">
                <form id="product-form" class="product-form" action="{{ route('customers.update', $data->id) }}" method="POST"
                        ...
                        <div class="col-sm-12">
                            <div class="header d-flex">
                                <span class="back-button">
                                    <h4 class="main-title ">
                                        <a class="text-decoration-none text-dark" href="{{ route('customers.index') }}">
                                            <span>← </span>Update Customers</a>
                        ...
                        <div class="col-sm-8">
                            <div class="row">
                                ...
                                <div class="form-section col-sm-6">
                                    ...
                                    <input type="text" id="email" name="email" value="{{ $data->email ?? old('email') }}"
                                        placeholder="example@gmail.com">
                                </div>
                                <div class="form-section col-sm-6">
                                    <label for="phone">Phone</label>
                                    <input type="text" id="phone" name="phone" value="{{ $data->phone ?? old('phone') }}"
                                ...
                                <div class="form-section col-sm-6">
                                    ...
                                    <input type="text" id="company" name="company" value="{{ $data->company ?? old('company') }}"
                                        placeholder="Company">
                                </div>
                               
                                <div class="form-section col-sm-6">
                                    <label for="country">Country</label>
                                    <input type="text" id="country" name="country" value="{{  $data->country ?? old('country') }}"
                                        placeholder="Country">
                                </div>
                               
                                <div class="form-section col-sm-6">
                                    <label for="state">State</label>
                                    <input type="text" id="state" name="state" value="{{ $data->state ?? old('state') }}"
                                        placeholder="state">
                                </div>
                                <div class="form-section col-sm-6">
                                    <label for="city">city</label>
                                    <input type="text" id="city" name="city" value="{{ $data->city ?? old('city') }}"
                                        placeholder="city">
                                </div>
                                <div class="form-section col-sm-6">
                                    <label for="zip">Zip Code (Postal Code )</label>
                                    <input type="text" id="zip" name="zip" value="{{ $data->zip ?? old('zip') }}"
                                        placeholder=" Zip Code">
                                </div>
                              
                                <div class="form-section col-sm-6">
                                    <label for="billingAddress">Billing Address</label>
                                    <textarea name="billingAddress" id="" placeholder="full address"> {{ $data->billingAddress ?? old('billingAddress') }}</textarea>
                                </div>
                                <div class="form-section col-sm-6">
                                    <label for="shippingAddress">Shipping Address</label>
                                    <textarea name="shippingAddress" id="" placeholder="full address"> {{ $data->shippingAddress ?? old('shippingAddress') }}</textarea>
                                </div>
                                    ...
                                    <div id="drop-zone" class="drop-zone">
                                        ...
                                        <div id="image-preview" class="image-preview">
                                            @if (!empty($data->images))
                                                <img src="{{ $data->images }}" height="100" alt="image">
                                            @endif    
                                        </div>
                                    </div>
