...
@section('content')
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-12">
                <form id="product-form" class="product-form" action="{{ route('adminusers.store') }}" method="POST"
                        ...
                        <div class="col-sm-4">
                            <aside class="">
                                ...
                                <div class="sidebar-section  p-2 mt-1">
                                    <input type="checkbox" name="is_super_admin" {{ old('is_super_admin') ? 'checked' : '' }} value="1" id="is_super_admin" >
