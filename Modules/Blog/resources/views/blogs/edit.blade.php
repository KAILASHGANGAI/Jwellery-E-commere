...
@section('content')
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-12">
                <form id="form" class="product-form" action="{{ route('blogs.update', $Blog) }}" method="POST"
                        ...
                        <div class="col-sm-8">
                            <div class="row">
                                ...
                                <div class="form-section d-fllex col-sm-12">
                                    ...
                                    <textarea id="description" name="description" rows="2" placeholder="Add Meta description for Seo">{{ old('description', $Blog->description) }}</textarea>
                                </div>
                            ...
                            <aside class="">
                                <div class="sidebar-section card p-2">
                                    ...
                                    <select id="status" name="status" required>
                                        <option {{ old('status', $Blog->status) == 0 ? 'selected' : '' }} value="0" selected>
                                            Unpublished</option>
                                        <option {{ old('status', $Blog->status) == '1' ? 'selected' : '' }} value="1">Published
                                        </option>
                                    </select>
                                ...
                                <div class="sidebar-section card p-2 mt-1">
                                    ...
                                    <select id="category_id" name="category_id" required>
                                        @foreach ($categories as $category)
                                            <option {{ old('category_id', $Blog->category_id) == $category->id ? 'selected' : '' }} value="{{ $category->id }}">{{ $category->title }}</option>
                                ...
                                <div class="form-section mt-2">
                                    ...
                                    <div id="drop-zone" class="drop-zone">
                                        ...
                                        <div id="image-preview" class="image-preview">
                                            ...
                                            <img src="{{ asset($Blog->featured_image) }}" height="100" alt="">
                                            @endif
                                        </div>
                                    </div>
                                ...
                                <div class="sidebar-section card p-3 mt-2">
                                    ...
                                    <div class="form-section">
                                        ...
                                        <textarea name="keywords" id="" placeholder="tag1, tag2"> {{ old('keywords', $Blog->keywords) }}</textarea>
