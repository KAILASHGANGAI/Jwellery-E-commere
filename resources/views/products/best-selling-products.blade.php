            ...
            <div class="col-12">
                <div class="product-area">
                    <div class="product_container bottom">
                        <div class="custom-row product_row2_sell">
    ...
    function loadProducts2() {
        $.ajax({
            ...
            success: function(response2) {
                var products2 = response2; // Assuming response contains products2 array
                var productHtml = '';

                // Loop through products2 and build HTML
                ...
                $(".product_row2_sell").html(productHtml);

                // Reinitialize Slick after adding new items
                $(".product_row2_sell").slick('unslick'); // Remove old instance
                initializeSlick2(); // Reinitialize with new products
            },
